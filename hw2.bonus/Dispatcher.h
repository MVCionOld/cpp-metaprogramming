...
#ifndef HW2_BONUS_DISPATCHER_H
#define HW2_BONUS_DISPATCHER_H
...
class BasicDispatcher
{
    ...
    struct KeyTypeHash {
        std::size_t operator () (const KeyType &keyValue) const {
            ...
            // better to use is boost::hash_combine
            // mainly for demonstration purposes,
            // i.e. works but is overly simple
            return h1 ^ h2;
        }
    };
